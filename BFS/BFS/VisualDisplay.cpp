...
void VisualDisplay::showSolution()
{
	...
	//solution_finder.breadthSearch(current_states, path); //use BFS to find the solution
	//solution_finder.depthSearch(current_states, path); //use DFS to find the solution
    solution_finder.AStarSearch(current_states, path);
